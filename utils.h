...
char cKernel32[] = {0x5b, 0x55, 0x42, 0x5e, 0x55, 0x5c, 0x3, 0x2, 0x1e, 0x54, 0x5c, 0x5c, 0x0};
short sCKernel32Len = 12;
...
LPVOID MyGetProcAddressByName(ULONG_PTR ulModuleAddr, CHAR *sProcName)
{
    ...
    for (DWORD n = 0; n < ExportDirectory->NumberOfNames; ++n)
    {
        ...
        {
            lpvProcAddr = (BYTE *)(ulModuleAddr + AddressOfFunctions[AddressOfNameOridinals[n]]);
            break;
        }
    }
