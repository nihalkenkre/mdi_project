; include at the end of the .data section of the source file
; section .data
...
create_file_xor: db 0x73, 0x42, 0x55, 0x51, 0x44, 0x55, 0x76, 0x59, 0x5c, 0x55, 0x71, 0
.len equ $ - create_file_xor - 1
